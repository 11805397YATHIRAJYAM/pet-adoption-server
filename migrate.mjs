...
const ATLAS_URI  = 'mongodb+srv://rajkumaryathirajyam_db_user:SyTW89AJGZki1old@cluster0.mb2zdhv.mongodb.net/pet_adoption?appName=Cluster0&tls=true&tlsAllowInvalidCertificates=true';
