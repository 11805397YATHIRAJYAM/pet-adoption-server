...
// Create a regular user for testing adoption
...
console.log('User     : user@petadopt.com    / Password123!');
console.log('----------------------------');
console.log('Shelter ID :', shelterId.toString());
console.log('Pets added :', petsToInsert.length);
